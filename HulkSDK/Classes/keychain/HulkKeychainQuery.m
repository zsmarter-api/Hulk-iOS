...
@implementation HulkKeychainQuery
...
- (BOOL)save:(NSError *__autoreleasing *)error {
	...
	if (status == errSecSuccess) {//item already exists, update it!
		...
		CFTypeRef accessibilityType = [HulkKeychain accessibilityType];
...
+ (NSError *)errorWithCode:(OSStatus) code {
	...
	dispatch_once(&onceToken, ^{
		NSURL *url = [[NSBundle bundleForClass:[HulkKeychainQuery class]] URLForResource:@"SAMKeychain" withExtension:@"bundle"];
